...
export default function LoginForm() {
  ...
  // Detectar cambio de tamaño para responsive
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div
        className="flex items-center justify-center min-h-screen font-[Work Sans] bg-[#EAF0F6] px-4 sm:px-0"
        style={{
          backgroundImage: !isMobile ? `url(${laptop})` : "none",
          backgroundRepeat: "no-repeat",
          backgroundPosition: "left center",
          backgroundSize: "62.5% auto",
        }}
      >
        <div className="shadow-xl rounded-2xl flex flex-col md:flex-row overflow-hidden w-full max-w-[1150px] bg-white md:h-[700px] h-auto mx-auto">
          ...
          {/* Formulario */}
          <div className={`flex flex-col justify-between px-8 py-6 md:rounded-r-2xl w-full md:w-1/2 items-center md:items-stretch ${isMobile ? "rounded-2xl mt-8 mb-8 mx-2" : ""}`}>
